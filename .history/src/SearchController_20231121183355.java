...
public class SearchController {
    ...
    public void atualizarTabela() {
        Platform.runLater(() -> {
            dadosDaTabela.clear();
            String selecaoCategoria = choiceBoxCategoria.getValue();
            if(selecaoCategoria.equals("Todas")){
                choiceBoxCategoria.setValue("Todas");
            }
            if(selecaoCategoria.equals("Smartphone")){
                choiceBoxCategoria.setValue("Smartphone");
            }
            if(selecaoCategoria.equals("Notebook")){
                choiceBoxCategoria.setValue("Notebook");
            }
            if(selecaoCategoria.equals("Tablet")){
                choiceBoxCategoria.setValue("Tablet");
            }
            if(selecaoCategoria.equals("Acessórios")){
                choiceBoxCategoria.setValue("Acessórios");
            }
            if(selecaoCategoria.equals("Periféricos")){
                choiceBoxCategoria.setValue("Periféricos");
            }
