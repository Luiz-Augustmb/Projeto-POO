...
public class IndexController implements Initializable{
    ...
    @FXML
    void goToRemovePage(MouseEvent event) throws IOException {
        removeImg();
    }
    ...
    public void removeImg() throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("removeLayout.fxml"));
        RemoveController removeController = fxml.getController();
        contentArea.getChildren().removeAll();
        contentArea.getChildren().setAll(fxml);           
    }
