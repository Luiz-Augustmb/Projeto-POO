...
public class SearchController {
    ...
    public void atualizarTabela(){
        ...
        try {
            // Carrega novamente a cena e o controlador
            FXMLLoader loader = new FXMLLoader(getClass().getResource("searchlayout.fxml"));
            Parent root = loader.load();
            SearchController novoController = loader.getController();

            // Cria uma nova cena
            Scene novaScene = new Scene(root);

            // Configura o palco e exibe a nova cena
            Stage novoStage = new Stage();
            novoStage.setScene(novaScene);
            novoStage.setTitle("Seu Título");
            novoStage.show();
