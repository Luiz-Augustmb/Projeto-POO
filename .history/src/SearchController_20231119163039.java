...
public class SearchController {
    ...
    void initialize() {
        ...
        for (Produto produto : arrayProdutos) {
            ...
            if (auxCategoria.equals("Smartphone")) {
            ...
            } else if (auxCategoria.equals("Notebook")) {
            ...
            } else if (auxCategoria.equals("Tablet")) {
            ...
            } else if (auxCategoria.equals("Periféricos")) {
            ...
            } else if (auxCategoria.equals("Acessórios")) {
