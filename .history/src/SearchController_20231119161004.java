...
public class SearchController {
    ...
    void initialize() {
        ...
        System.out.println(arrayProdutos.get(1).getQtd());
        ...
        for(int i = 0; i < arrayProdutos.size(); i++){
            if (arrayProdutos.get(i).getCategoria().equals("Smartphone")) {
                ...
                System.out.println(auxCategoria);
                System.out.println(auxMarca);
                System.out.println(auxModelo);
                System.out.println(auxPreco);
                System.out.println(auxQtd);
