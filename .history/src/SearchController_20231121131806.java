...
public class SearchController {
    ...
    public void atualizarTabela(){
        Platform.runLater(() -> {
            tabelaProdutos.getItems().clear();  // Limpar os itens existentes
        tabelaProdutos.getItems().addAll(dadosDaTabela);  // Adicionar os dados atualizados
        tabelaProdutos.refresh();  // Atualizar a tabela
        });
    }
}
