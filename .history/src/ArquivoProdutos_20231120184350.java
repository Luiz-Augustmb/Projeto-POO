...
public class ArquivoProdutos {
    ...
    public void excluir(Produto produtoParaExcluir) {
        ...
        for (int i = 0; i < produtos.size(); i++) {
            if (produtos.get(i).getCategoria().equals(produtoParaExcluir.getCategoria())
                    && produtos.get(i).getMarca().equals(produtoParaExcluir.getMarca())
                    && produtos.get(i).getModelo().equals(produtoParaExcluir.getModelo())
                    && produtos.get(i).getPreco().equals(produtoParaExcluir.getPreco())
                    && produtos.get(i).getQtd().equals(produtoParaExcluir.getQtd())) {
