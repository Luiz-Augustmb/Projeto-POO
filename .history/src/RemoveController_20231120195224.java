...
public class RemoveController {
    ...
    void atualizarProduto(ActionEvent event) {
        ...
        String categoriaAtualizarProduto = produtoSelecionado.getCategoria();
        String marcaAtualizarProduto = produtoSelecionado.getMarca();
        String modeloAtualizarProduto = produtoSelecionado.getModelo();
        double precoAtualizarProduto = produtoSelecionado.getPreco();
        int qtdAtualizarProduto = produtoSelecionado.getQtd();
