...
public class UsersController {
    ...
    @FXML
    TableColumn<Usuario, Void> colunaExcluir = new TableColumn<>("Ações");
    ...
    void initialize() {
        ...
        colunaExcluir.setCellFactory(param -> new TableCell<>() {
            private final ImageView imageView = new ImageView(new Image(getClass().getResourceAsStream("FontAwesomeIcon.TRASHS")));
        ...
        tabelaUsuarios.getColumns().add(colunaExcluir);
