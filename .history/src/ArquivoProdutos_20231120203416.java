...
public class ArquivoProdutos {
    ...
    public void atualizar(Produto produtoParaAtualizar, Produto produtoAtualizado) {
        ...
        for (int i = 0; i < produtos.size(); i++) {
            ...
            if (produto.getCategoria().equals(produtoParaAtualizar.getCategoria()) &&
                produto.getMarca().equals(produtoParaAtualizar.getMarca()) &&
                produto.getModelo().equals(produtoParaAtualizar.getModelo()) &&
                produto.getPreco() == produtoParaAtualizar.getPreco() &&
                produto.getQtd() == produtoParaAtualizar.getQtd()) 
            { 
    ...
    public void excluir(Produto produtoParaExcluir) {
        ...
        produtos.removeIf(produto -> produto.getCategoria().equals(produtoParaExcluir.getCategoria()) &&
