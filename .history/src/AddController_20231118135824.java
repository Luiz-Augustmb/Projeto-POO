    ...
    public void addProduto(ActionEvent event) {
        ...
        try{
            if (!categoriaSelecionada.isEmpty() && !inputMarca.isEmpty() && !inputModelo.isEmpty() && !inputPreco.isEmpty()
                ...
                alertaConfirmacao.initOwner(addProdutoButton.getScene().getWindow()); // Definir o dono (janela pai) do Alert
                ...
                alertaErro.initOwner(addProdutoButton.getScene().getWindow());
