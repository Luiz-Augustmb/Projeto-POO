    ...
    void initialize() {
        ...
        colunaAcoes.setCellFactory(param -> new TableCell<>() {
...

            {
                ...
                buttonDelete.getStyleClass().add("acoes-button");
                buttonEdit.getStyleClass().add("acoes-button");
                ...
                buttonEdit.setOnAction(event -> {
                    ...
                    try {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("updateUserLayout.fxml"));
                        Parent root = loader.load();
                        
                        UpdateUserController updateUserController = loader.getController();
                        updateUserController.setUsuarioSelecionado(usuario);
                        updateUserController.setUsersController(UsersController.this);
