...
public class RemoveController {
    ...
    void atualizarProduto(ActionEvent event) {
        ...
        String categoriaAtualizarProduto = textFildCategoria.getText();
        String marcaAtualizarProduto = textFieldMarca.getText();
        String modeloAtualizarProduto = textFieldModelo.getText();
        double precoAtualizarProduto = Double.parseDouble(textFieldPreco.getText());
        int qtdAtualizarProduto = Integer.parseInt(textFieldQuantidade.getText());
