...
public class AddUserController {
    ...
    void addNovoUsuario(ActionEvent event) {
        ...
        if(!nomeUsuario.isEmpty() && !usuario.isEmpty() && !senhaUsuario.isEmpty()){
            ...
            Platform.runLater(() -> {
                        try {
                            addUserControler.atualizarTabela();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    });
    ...
    private AddUserController addUserControler;

    public void setUserController(AddUserController addUserControler) {
        this.addUserControler = addUserControler;
    }
}
