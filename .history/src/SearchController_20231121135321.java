...
public class SearchController {
    ...
    public SimpleStringProperty configurarTabela() {
        ...
        colunaPreco.setCellValueFactory(cellData -> extracted(cellData));
    ...
    private ObservableValue<Double> extracted(CellDataFeatures<Produto, Double> cellData) {
