...
public class SearchController {
    ...
    void initialize() {
        ...
        for(int i = 0; i < arrayProdutos.size(); i++){
            if(arrayProdutos.get(i).getCategoria().equalsIgnoreCase("Sarmtphone")){
                System.out.println("TESTES");
                arraySmartphone.add((Smartphone) arrayProdutos.get(i));
                System.out.println(arraySmartphone.get(i));
                ...
                arrayPerifericos.add((Perifericos) arrayProdutos.get(i));
                System.out.println(arraySmartphone.get(i));
            }
        }
