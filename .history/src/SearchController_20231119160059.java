    ...
    void initialize() {
        ...
        for(int i = 0; i < arrayProdutos.size(); i++){
            if (arrayProdutos.get(i).getCategoria().equals("Smartphone")) {
                Smartphone auxSmartphone = new Smartphone((arrayProdutos.get(i).getCategoria()) ,
                    (arrayProdutos.get(i).getMarca()), (arrayProdutos.get(i).getModelo(), arrayPerifericos.get(i).getPreco(), 
                    arrayProdutos.get(i).getQtd());
