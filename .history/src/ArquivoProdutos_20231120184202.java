...
public class ArquivoProdutos{
    ...
    public void atualizar(Produto produtoParaAtualizar, Produto produtoAtualizado) {
        ...
        for (int i = 0; i < produtos.size(); i++) {
            ...
            if (produto.equals(produtoParaAtualizar)) { // Implemente um método equals() em Produto para verificar igualdade
    ...
    public void excluir(Produto produtoParaExcluir) {
        ...
        produtos.removeIf(produto -> produto.equals(produtoParaExcluir)); // Implemente um método equals() em Produto para verificar igualdade
        for(int i = 0; i < produtos.size() ; i++){
            if(produtos.get(i).getCategoria().equals(produtoParaExcluir.getCategoria()) && produtos.get(i).getMarca().equals(produtoParaExcluir.getMarca())){
