    ...
    void initialize() {
        ...
        for (Produto produto : arrayProdutos) {
            ...
            if (produto.getCategoria().equals("Notebook")) {
                System.out.println("Entrou no bloco Notebook"); // Adicione esta linha
        ...
        System.out.println(arraySmartphone.size());
        System.out.println(arrayNotebook.size());
        System.out.println(arrayTablet.size());
        System.out.println(arrayAcessorios.size());
        System.out.println(arrayPerifericos.size());
